...
const segments = computed<Segment[]>(() => {
    ...
    return [
        ...
        },
        {
            ...
            type: 'info',
            icon: Lock,
            tip: t('firewall.flowBaselineTip'),
        ...
        },
        {
            ...
            tip: props.defaultDrop ? t('firewall.flowDefaultStrictTip') : t('firewall.flowDefaultLooseTip'),
            clickable: false,
            active: false,
        },
    ];
