...
const message = {
    ...
    firewall: {
        ...
        portHelper1: 'e.g. 8080, multiple 8080,8081, range 8080-8089',
        strategy: 'Strategy',
        accept: 'Accept',
        drop: 'Drop',
        anyWhere: 'Any',
        ...
        addressHelper1: 'e.g. 172.16.10.11 or 172.16.0.0/24, comma-separated for multiple',
        allIP: 'All IP',
        ...
        flowSectionTitle: 'Inbound evaluation order',
        flowSectionHint: 'Matched top-down; the first match wins, otherwise the default policy applies.',
        flowInbound: 'Inbound',
        ...
        intentLabel: 'Intent',
        intentAllowPort: 'Allow port',
        intentBlockPort: 'Block port',
        intentBlockSource: 'Block source IP',
        intentAllowSource: 'Allow source IP',
        effectSummaryPort: '{0} {1} {2} from {3}',
        effectSummaryAddr: '{0} inbound access from {1}',
        ...
        sectionActionsTip: 'Start/stop, init, whitelist mode and the pending confirm session',
