...
const message = {
    ...
    terminal: {
        ...
        pinSession: 'Pin session (keep it connected when leaving this page)',
        unpinSession: 'Unpin session',
        closePinnedConfirm: 'This session is pinned. Closing the tab will end the shell on the server. Continue?',
        ...
        user: {
            ...
            auth: {
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Reads this Attribute from the verified SAML Assertion and maps it to the 1Panel username.',
                    ...
                    syncLogoutHelper:
                        'Signing out of either 1Panel or the identity provider also signs out the other side.',
