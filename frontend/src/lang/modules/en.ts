...
const message = {
    ...
    firewall: {
        ...
        switchProvider: 'Switch Backend',
        switchProviderTitle: 'Switch Firewall Backend',
        switchProviderHelper:
            'Choose which backend 1Panel should manage rules with. The change takes effect immediately for new operations; restart the agent to re-run boot-time recovery against the new backend.',
        switchProviderSuccess: 'Preference saved. Restart 1panel-agent so the new backend takes over boot-time recovery.',
        switchProviderBlocked: 'Cannot switch backend: {0}',
        switchTo: 'Switch to',
        switchConfirmTitle: 'Switch from {0} to {1}?',
        switchForceHint:
            'The current backend already has live rules. The cutover may briefly affect connectivity. A snapshot is captured first so you can recover if anything goes wrong.',
        switchForceAccept: 'I understand, continue with the switch',
        providerName: 'Backend',
        providerStatus: 'Status',
        providerAction: 'Action',
        providerCurrent: 'Active',
        providerAvailable: 'Installed',
        providerNotAvailable: 'Not installed',
        providerInitialized: 'Managing live rules',
        providerPreferredLabel: 'Preferred: {0}',
        providerNameValue: {
            iptables: 'iptables',
            nftables: 'nftables',
            ufw: 'ufw',
        ...
        nativeFirewallInCharge:
            'The system firewall "{0}" is active — backend switching does not apply. Uninstall it first if you want 1Panel to manage rules directly.',
        noProviderChoice: 'Only one managed backend is installed on this host. Nothing to switch to.',
        snapshots: 'Snapshots',
        snapshotsTitle: 'Firewall Snapshots',
        snapshotsHelper:
            '1Panel captures an iptables-save snapshot before every destructive change and keeps the last ten. If a change breaks something, restore the latest healthy snapshot below.',
        snapshotName: 'Snapshot',
        snapshotTag: 'Reason',
        snapshotCreatedAt: 'Captured at',
        snapshotSize: 'Size',
        restoreSnapshot: 'Restore',
        restoreSnapshotConfirm:
            'Restoring snapshot "{0}" will atomically replace the current iptables ruleset. Rules added after this snapshot will be lost. Continue?',
        restoreSnapshotSuccess: 'Snapshot restored.',
        noSnapshots: 'No snapshots yet — one is captured the first time you make a rule change.',
    },
    runtime: {
        runtime: 'Runtime',
