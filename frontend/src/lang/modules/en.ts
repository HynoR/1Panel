...
const message = {
    ...
    firewall: {
        ...
        rescueChannel: "Rescue channels (won't lock you out)",
        rescueAllowed: 'Allowed',
        rescueClosable: 'Closable',
        rescueReadOnly: 'Baseline (read-only)',
        ...
        flowRescue: 'Rescue',
        flowDeny: 'Blocklist',
        flowBaseline: 'Protected baseline',
        flowAllow: 'Allowlist',
        ...
        flowBaselineTip:
            'Always-on access for key ports such as SSH and the panel; cannot be deleted or flipped to block.',
        ...
        levelDeny: 'Blocklist',
        levelBaseline: 'Protected baseline',
        levelAllow: 'Allowlist',
        noListen: 'No listener',
        cleanOrphan: 'Clean orphan records',
        ...
        redlineBlockBoth:
            'This rule would block both SSH and the 1Panel console; rejected. To deny inbound by default, use the Strict Mode switch.',
