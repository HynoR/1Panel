...
const message = {
    ...
    terminal: {
        ...
        pinSession: 'Sematkan sesi (kekal bersambung apabila meninggalkan halaman ini)',
        unpinSession: 'Nyahsemat sesi',
        closePinnedConfirm: 'Sesi ini disematkan. Menutup tab akan menamatkan shell pada pelayan. Teruskan?',
