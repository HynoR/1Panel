...
const message = {
    ...
    firewall: {
        ...
        plan_requested_rule_is_covered: '现有规则已经覆盖本次配置，继续创建会产生重叠规则。',
        ...
        ruleCheckWarningHelper: '检查完成。警告不会阻止提交，可以直接继续。',
        plan_managed_rule_drifted: '1Panel 管理记录与系统实际规则不一致，请检查系统规则。',
        ...
        plan_overlapping_rule_with_different_action: '存在范围重叠但动作相反的规则，本次操作已停止。',
        plan_partially_overlapping_rule_with_different_action:
            '与相反动作的规则部分重叠，实际效果取决于规则顺序，确认后可继续。',
        ...
        ruleSyncTitle: '同步规则',
        ruleSyncAction: '同步规则',
        ruleSyncHelper: '将所选防火墙中由 1Panel 管理的规则同步到当前防火墙。原规则不会删除，外部规则不会同步。',
