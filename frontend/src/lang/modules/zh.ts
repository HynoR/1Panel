...
const message = {
    ...
    firewall: {
        ...
        rescueChannel: '保底通道（不会被锁外）',
        rescueAllowed: '已放行',
        rescueClosable: '可关闭',
        rescueReadOnly: '保底（只读）',
        ...
        flowBaselineTip: '始终放行 SSH、面板等关键端口，不可删除或改为屏蔽。',
        ...
        riskProceed: '仍要应用',
        redlineTitle: '操作已拒绝',
        redlineBlockBoth: '该规则会同时阻断 SSH 与 1Panel 面板，已拒绝。如需默认拒绝入站，请使用「严格模式」开关。',
        applying: '正在应用防火墙变更…',
        ...
        sectionActionsTip: '启停、初始化、严格模式与待确认会话',
