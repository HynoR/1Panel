...
const message = {
    ...
    firewall: {
        ...
        switchProvider: '切换后端',
        switchProviderTitle: '切换防火墙后端',
        switchProviderHelper:
            '选择 1Panel 用哪个后端管理规则。切换后新操作立即生效；若要新后端也接管开机恢复逻辑，请重启 agent。',
        switchProviderSuccess: '偏好已保存。请重启 1panel-agent 以按新后端执行开机初始化。',
        switchProviderBlocked: '无法切换后端：{0}',
        switchTo: '切换到',
        switchConfirmTitle: '确定从 {0} 切换到 {1} 吗？',
        switchForceHint:
            '当前后端已有生效规则。切换过程可能短暂影响连通性。系统会先自动生成一份快照，出问题可随时回滚。',
        switchForceAccept: '我已了解，继续切换',
        providerName: '后端',
        providerStatus: '状态',
        providerAction: '操作',
        providerCurrent: '使用中',
        providerAvailable: '已安装',
        providerNotAvailable: '未安装',
        providerInitialized: '托管规则中',
        providerPreferredLabel: '偏好：{0}',
        providerNameValue: {
            iptables: 'iptables',
            nftables: 'nftables',
            ufw: 'ufw',
        ...
        nativeFirewallInCharge:
            '系统防火墙 "{0}" 正在运行，无法切换托管后端。如需改由 1Panel 接管，请先卸载它。',
        noProviderChoice: '当前主机只安装了一个托管后端，没有可切换的目标。',
        snapshots: '规则快照',
        snapshotsTitle: '防火墙规则快照',
        snapshotsHelper:
            '每次破坏性改动前 1Panel 会自动对 iptables 规则集打一份 iptables-save 快照，最多保留 10 份。改错了可以从下方挑一份健康的快照恢复。',
        snapshotName: '快照',
        snapshotTag: '触发原因',
        ...
        restoreSnapshotConfirm:
            '恢复快照 "{0}" 将原子替换当前 iptables 规则集，此快照之后新增的规则会丢失。确定继续吗？',
        restoreSnapshotSuccess: '快照已恢复。',
        noSnapshots: '暂无快照。首次改动规则时会自动生成。',
    },
    runtime: {
        runtime: '运行环境',
        workDir: '工作目录',
