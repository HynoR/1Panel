...
const message = {
    ...
    tabs: {
        ...
        keepAlive: 'Сохранять сеанс страницы',
    ...
    terminal: {
        ...
        pinSession: 'Закрепить сессию (сохранять подключение при уходе со страницы)',
        unpinSession: 'Открепить сессию',
        closePinnedConfirm: 'Сессия закреплена. Закрытие вкладки завершит shell на сервере. Продолжить?',
    ...
    setting: {
        ...
        menuTabsHelper: 'После включения нажмите кнопку блокировки на вкладке, чтобы сохранить сеанс страницы.',
    ...
    firewall: {
        ...
        dockerTrafficPathMixed: 'Выбранные порты используют разные пути доступа. Настройте их отдельно.',
        dockerTrafficPathUnknown:
            'Не удалось определить путь доступа к этому порту. Проверьте сеть Docker и повторите попытку.',
